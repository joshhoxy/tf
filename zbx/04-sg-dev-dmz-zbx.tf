resource "aws_security_group" "sg-dev-dmz-pub-zbx-1" {
  name        = var.sg-dev-dmz-pub-zbx-1-name
...
resource "aws_security_group_rule" "sgr-dev-dmz-pub-zbx-1" {
...
resource "aws_security_group_rule" "sgr-dev-dmz-pub-zbx-2" {
  # provider = aws.snm-dev
  type              = "ingress"
  from_port         = 443
  to_port           = 443
...
resource "aws_security_group_rule" "sgr-dev-dmz-pub-zbx-3" {
  # provider = aws.snm-dev
  type              = "ingress"
  from_port         = 10051
  to_port           = 10051
